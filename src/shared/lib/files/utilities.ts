 ...
 */
export function resetAndGetOrientation(arrayBuffer: ArrayBuffer) {
 ...
 */
export function insertExif(arrayBuffer: ArrayBuffer, exifArray: number[]) {
    const array = Array.from(new Uint8Array(arrayBuffer));
    ...
    const newBuffer = new Uint8Array(newArrayBuffer);
